...
-- ----------------------------
INSERT INTO `activity_info` VALUES (1, '端午部分蔬菜活动', 1, '端午部分蔬菜活动的', '2023-10-10', '2023-10-12', '2023-10-10 00:00:00', '2023-10-11 20:12:36', 0);
INSERT INTO `activity_info` VALUES (2, '元旦满减券', 1, '2022年元旦满减券', '2021-11-11', '2022-01-11', '2021-11-11 12:47:26', '2023-10-11 18:11:10', 0);
INSERT INTO `activity_info` VALUES (3, '测试活动', 1, '一个测试', '2023-10-08', '2023-10-21', '2023-10-11 18:16:40', '2023-10-15 11:04:09', 0);
...
CREATE TABLE `activity_rule`  (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优惠规则' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of activity_rule
-- ----------------------------
INSERT INTO `activity_rule` VALUES (1, 1, 1, 10.00, NULL, 2.00, NULL, '2021-06-06 18:28:25', '2023-10-11 19:25:13', 0);
INSERT INTO `activity_rule` VALUES (2, 1, 1, 29.00, NULL, 6.00, NULL, '2021-06-06 18:28:25', '2023-10-11 19:25:16', 0);
INSERT INTO `activity_rule` VALUES (3, 2, 1, 20.00, NULL, 5.00, NULL, '2021-11-11 04:47:51', '2023-10-11 20:15:48', 1);
INSERT INTO `activity_rule` VALUES (4, 2, 1, 20.00, NULL, 2.00, NULL, '2023-10-11 20:21:57', '2023-10-13 13:03:59', 1);
INSERT INTO `activity_rule` VALUES (5, 3, 2, 20.00, 10, 2.00, 1.00, '2023-10-11 20:22:31', '2023-10-11 20:22:48', 1);
INSERT INTO `activity_rule` VALUES (6, 3, 2, 20.00, 20, 2.00, 3.00, '2023-10-11 20:22:31', '2023-10-11 20:22:48', 1);
INSERT INTO `activity_rule` VALUES (7, 3, 2, 20.00, 20, 2.00, 3.00, '2023-10-11 20:22:31', '2023-10-11 20:23:34', 1);
INSERT INTO `activity_rule` VALUES (8, 3, 2, 20.00, 40, 2.00, 5.00, '2023-10-11 20:22:48', '2023-10-11 20:23:34', 1);
INSERT INTO `activity_rule` VALUES (9, 3, 2, 20.00, 20, 2.00, 3.00, '2023-10-11 20:22:31', '2023-10-14 01:04:19', 1);
INSERT INTO `activity_rule` VALUES (10, 3, 2, 20.00, 40, 2.00, 5.00, '2023-10-11 20:22:48', '2023-10-14 01:04:19', 1);
INSERT INTO `activity_rule` VALUES (11, 2, 1, 20.00, NULL, 2.00, NULL, '2023-10-11 20:21:57', '2023-10-11 20:21:57', 0);
INSERT INTO `activity_rule` VALUES (12, 3, 1, 20.00, 40, 2.00, 5.00, '2023-10-11 20:22:48', '2023-10-14 16:24:07', 1);
INSERT INTO `activity_rule` VALUES (13, 3, 1, 40.00, NULL, 5.00, NULL, '2023-10-14 01:04:19', '2023-10-14 16:24:07', 1);
INSERT INTO `activity_rule` VALUES (14, 3, 1, 20.00, 40, 2.00, 5.00, '2023-10-11 20:22:48', '2023-10-14 16:26:21', 1);
INSERT INTO `activity_rule` VALUES (15, 3, 1, 40.00, NULL, 5.00, NULL, '2023-10-14 01:04:19', '2023-10-14 16:26:21', 1);
INSERT INTO `activity_rule` VALUES (16, 3, 1, 20.00, 40, 2.00, 5.00, '2023-10-11 20:22:48', '2023-10-11 20:22:48', 0);
INSERT INTO `activity_rule` VALUES (17, 3, 1, 40.00, NULL, 5.00, NULL, '2023-10-14 01:04:19', '2023-10-14 01:04:19', 0);
...
CREATE TABLE `activity_sku`  (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '活动参与商品' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of activity_sku
-- ----------------------------
INSERT INTO `activity_sku` VALUES (1, 1, 1, '2021-06-06 18:28:25', '2023-10-11 19:31:56', 0);
INSERT INTO `activity_sku` VALUES (2, 1, 2, '2021-06-06 18:28:25', '2023-10-11 19:32:00', 0);
INSERT INTO `activity_sku` VALUES (3, 3, 5, '2023-10-11 20:23:34', '2023-10-14 01:04:19', 1);
INSERT INTO `activity_sku` VALUES (4, 3, 15, '2023-10-11 20:23:34', '2023-10-14 01:04:19', 1);
INSERT INTO `activity_sku` VALUES (5, 2, 3, '2023-10-13 13:03:59', '2023-10-13 13:03:59', 0);
INSERT INTO `activity_sku` VALUES (6, 3, 5, '2023-10-14 01:04:19', '2023-10-14 16:24:07', 1);
INSERT INTO `activity_sku` VALUES (7, 3, 15, '2023-10-14 01:04:19', '2023-10-14 16:24:07', 1);
INSERT INTO `activity_sku` VALUES (8, 3, 5, '2023-10-14 16:24:07', '2023-10-14 16:26:21', 1);
INSERT INTO `activity_sku` VALUES (9, 3, 5, '2023-10-14 16:26:21', '2023-10-14 16:26:21', 0);
INSERT INTO `activity_sku` VALUES (10, 3, 1, '2023-10-14 16:26:21', '2023-10-14 16:26:21', 0);
INSERT INTO `activity_sku` VALUES (11, 3, 2, '2023-10-14 16:26:21', '2023-10-14 16:26:21', 0);
...
-- ----------------------------
INSERT INTO `coupon_info` VALUES (1, 1, '端午满9元减2元', 2.00, 9.00, '2021-06-03', '2022-07-10', 2, '可购买：土豆与玉米', 100, 1, 0, 5, '2022-07-02 00:00:00', NULL, '2021-06-06 18:29:14', '2023-10-11 22:50:41', 1);
INSERT INTO `coupon_info` VALUES (2, 1, '端午优惠券15减3元', 3.00, 15.00, '2021-08-04', '2022-10-06', 2, '可购买：土豆与玉米', 100, 1, 0, 5, '2022-08-26 00:00:00', NULL, '2021-08-17 11:35:56', '2023-10-11 22:50:47', 1);
...
INSERT INTO `coupon_info` VALUES (6, 2, '元旦现金券', 2.00, 0.00, '2021-11-11', '2022-01-11', 3, '可购买分类：数码家电,母婴玩具', 10, 1, 0, 1, '2022-01-12 00:00:00', NULL, '2021-11-11 04:48:33', '2023-10-11 22:50:33', 0);
INSERT INTO `coupon_info` VALUES (7, 2, '测试优惠券', 50.00, 0.00, '2023-10-10', '2023-10-15', 2, '可购买：undefined,：undefined', 100, 1, 0, 0, '2023-10-31 00:00:00', NULL, '2023-10-11 22:29:09', '2023-10-14 00:45:10', 0);
INSERT INTO `coupon_info` VALUES (8, 1, '测试满减券', 2.00, 0.00, '2023-10-10', '2023-10-26', 1, '', 5, 1, 0, 0, '2023-10-28 00:00:00', NULL, '2023-10-11 22:51:41', '2023-10-13 23:49:47', 0);
...
CREATE TABLE `coupon_range`  (
  ...
  `is_deleted` tinyint NOT NULL DEFAULT 0 COMMENT '删除标记（0:不可用 1:可用）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优惠券范围表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of coupon_range
-- ----------------------------
INSERT INTO `coupon_range` VALUES (1, 1, 2, 3, '2021-06-06 18:30:06', '2023-10-11 22:50:41', 1);
INSERT INTO `coupon_range` VALUES (2, 1, 2, 4, '2021-06-06 18:30:06', '2023-10-11 22:50:41', 1);
INSERT INTO `coupon_range` VALUES (3, 1, 2, 1, '2021-06-06 18:30:28', '2023-10-11 22:50:41', 1);
INSERT INTO `coupon_range` VALUES (4, 2, 2, 6, '2021-08-17 11:37:24', '2023-10-11 22:50:47', 1);
INSERT INTO `coupon_range` VALUES (5, 2, 2, 2, '2021-08-17 11:37:31', '2023-10-11 22:50:47', 1);
INSERT INTO `coupon_range` VALUES (6, 2, 2, 5, '2021-09-14 09:20:31', '2023-10-11 22:50:47', 1);
INSERT INTO `coupon_range` VALUES (7, 7, 2, 13, '2023-10-11 22:31:10', '2023-10-14 16:23:29', 1);
INSERT INTO `coupon_range` VALUES (8, 7, 2, 5, '2023-10-11 22:31:50', '2023-10-14 16:23:29', 1);
INSERT INTO `coupon_range` VALUES (9, 7, 2, 3, '2023-10-11 22:31:50', '2023-10-14 16:23:29', 1);
INSERT INTO `coupon_range` VALUES (10, 6, 3, 14, '2023-10-11 22:47:35', '2023-10-11 22:47:35', 0);
INSERT INTO `coupon_range` VALUES (11, 6, 3, 13, '2023-10-11 22:47:35', '2023-10-11 22:47:35', 0);
INSERT INTO `coupon_range` VALUES (12, 7, 2, 3, '2023-10-14 16:23:29', '2023-10-14 16:25:01', 1);
INSERT INTO `coupon_range` VALUES (13, 7, 2, 5, '2023-10-14 16:23:29', '2023-10-14 16:25:01', 1);
INSERT INTO `coupon_range` VALUES (14, 7, 2, 3, '2023-10-14 16:25:01', '2023-10-14 16:25:01', 0);
INSERT INTO `coupon_range` VALUES (15, 7, 2, 15, '2023-10-14 16:25:01', '2023-10-14 16:25:01', 0);
...
INSERT INTO `coupon_use` VALUES (15, 7, 38, NULL, 1, 2, '2021-11-25 15:15:35', NULL, NULL, '2022-08-26 00:00:00', '2021-11-25 07:15:35', '2023-10-13 23:50:42', 0);
INSERT INTO `coupon_use` VALUES (16, 8, 38, NULL, 1, 2, '2021-11-25 15:15:35', NULL, NULL, '2022-08-26 00:00:00', '2021-11-25 07:15:35', '2023-10-13 23:50:42', 0);
